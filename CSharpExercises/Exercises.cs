...
namespace CSharpExercises
{
    public static class Exercises
    {
        ...
        {
            double minutesPerHour = minutes / 60.0;
            double secondsPerHour = seconds / 3600.0;
            double time = hours + minutesPerHour + secondsPerHour;
            string speedMPH = $"{Math.Round(distance / time)}";
            return $"{speedMPH}MPH";
        }
